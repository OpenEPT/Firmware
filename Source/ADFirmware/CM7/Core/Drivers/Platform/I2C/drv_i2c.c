...
{
	drv_i2c_instance_t					instance;
	drv_i2c_initialization_status_t		initState;
	drv_i2c_config_t					config;
	SemaphoreHandle_t					lock;
	I2C_HandleTypeDef 					deviceHandler;
}drv_i2c_handle_t;
...
drv_i2c_status_t	DRV_I2C_Instance_Init(drv_i2c_instance_t instance, drv_i2c_config_t* config)
{
	...
	if (HAL_I2CEx_ConfigDigitalFilter(&prvDRV_I2C1_INSTANCE.deviceHandler, 0) != HAL_OK)
